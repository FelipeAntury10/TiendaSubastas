...
namespace lib_presentaciones.Implementaciones
{
    public class ClientesPresentacion : IClientesPresentacion
    {
        ...
        public async Task<List<Clientes>> BuscarPorDocumento(Clientes? entidad)
        {
            var lista = new List<Clientes>();
            var datos = new Dictionary<string, object> { ["Entidad"] = entidad! };

            comunicaciones = new Comunicaciones();
            datos = comunicaciones.ConstruirUrl(datos, "Clientes/BuscarPorDocumento");
            var respuesta = await comunicaciones.Execute(datos);
        ...
        public async Task<List<Clientes>> PorNombre(Clientes clientes)
        {
            var lista = new List<Clientes>();
            var datos = new Dictionary<string, object> { ["Entidad"] = clientes };
